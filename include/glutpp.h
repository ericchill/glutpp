...
namespace glutpp {
    ...
    intType constexpr operator~(intType a) {
     ...
     */
    template<typename intType>
    intType constexpr operator&(intType a, intType b) {
	...
	Window& operator=(const Window& other) { _impl = other._impl; return *this; }
	...
	virtual bool closeWindow(Window window) { return true; }
